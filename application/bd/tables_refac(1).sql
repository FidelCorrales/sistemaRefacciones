...
-- drop table Tipo_Autoparte;
-- drop table Unidad_Medida;
-- drop table Usuario;
-- drop table Pedido;
-- drop table Pedido_has_Autoparte;
-- drop table Comentartios;
...
compras_realizadas number(10)not null
);
...
insert into Autoparte values(020017,'Duralast','semi-metalica',10,121234,734.99,'Mordaza de Freno-Delantero der','Grand-i10,Ionic',2);
...
----------------------------------Herramientas----------------------------------------------------
insert into Autoparte values(040001,'Torx','acero',5,4041,124.05,'Kit desarmadores-torx','Universal',4);
insert into Autoparte values(040002,'Petrul','acero',5,4042,232.05,'Pinzas de presion','Universal',4);
insert into Autoparte values(040003,'Truper','acero',5,4043,89.05,'Kit llaves alen ','Universal',4);
insert into Autoparte values(040004,'Urrea','acero',5,4044,324.05,'Kit pinzas-resistente ','Universal',4);
insert into Autoparte values(040005,'Tommer','acero',5,4045,634.05,'Gato Hidrauilico patin 1ton','Universal',4);
insert into Autoparte values(040006,'Truper','acero',5,4046,124.36,'Gato botella 1/2 ton','Universal',4);
insert into Autoparte values(040007,'Urrea','acero',5,4046,784.05,'Autocle dados mili.','Universal',4);
insert into Autoparte values(040008,'Craftsman','acero',5,4047,728.21,'Kit dados alt-resistencia','Universal',4);
insert into Autoparte values(040009,'Prostkit','acero',5,4048,391.18,'Kit desarmadores ','Universal',4);
